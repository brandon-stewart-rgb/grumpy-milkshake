						...
						<div className="column is-10 has-text-centered is-offset-1">
							<div className="box">
								<p className="subtitle">
									Please feel free to download my resume below, it has all of my
									current contact info, stats, background, likes, dislikes and
							...
							<Link
								className="button"
								target="_blank"
								to="/files/Brandon_Stewart_2021.pdf"
							>
